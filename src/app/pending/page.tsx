...
import { Zap, Clock, Mail, ArrowLeft, Shield } from "lucide-react"
        ...
        <CardContent className="space-y-6 text-center">
          ...
          <div className="rounded-xl bg-slate-800/50 p-4 space-y-3">
            <div className="flex items-center gap-3 text-slate-300">
              ...
              <span className="text-sm">Contact the admin to approve your account</span>
            </div>
            <div className="flex items-center gap-3 text-slate-300">
              <Shield className="h-4 w-4 text-slate-500" />
              <span className="text-sm">Once approved, you&apos;ll be assigned a role (Admin or Sales)</span>
            </div>
            <div className="flex items-center gap-3 text-slate-300">
              <Zap className="h-4 w-4 text-slate-500" />
              <span className="text-sm">You&apos;ll be notified once your account is approved</span>
            </div>
          </div>
