...
import { Store, Mail, Lock, Eye, EyeOff, Loader2, CheckCircle2, Moon, Sun, Sparkles, ArrowRight, Users } from "lucide-react"
          ...
          <Card className="border-border/60 bg-card/80 backdrop-blur-xl shadow-2xl">
            <CardHeader className="space-y-2 text-center">
              ...
              <CardDescription className="text-base">
                Sign in to your Stock Manage account
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {registered && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="flex items-center gap-2 rounded-xl bg-success/10 border border-success/20 p-3 text-success text-sm"
                >
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full h-11 rounded-xl border-border/60 gap-2"
      ...
      <div className="hidden lg:flex lg:w-[55%] relative bg-gradient-to-br from-primary/10 via-primary/5 to-background p-12 flex-col justify-center">
        ...
        >
          ...
          <h1 className="text-3xl font-bold tracking-tight mb-6">
            ...
            <span className="text-primary">for modern retailers</span>
          </h1>
          ...
          <motion.div
            ...
            className="mt-8 p-4 rounded-xl bg-gradient-to-br from-primary/10 to-success/10 border border-border/60"
          >
